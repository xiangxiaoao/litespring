...
/**
 * GCLIB -based{@link AopProxyFactory} implementation for the Spring AOP framework
 */
@SuppressWarnings("serial")
public class CglibProxyFactory implements AopProxyFactory {
    //Constants for GCLIB callback array indices
    private static final int AOP_PROXY = 0;
    private static final int INVOKE_TARGET = 1;
    private static final int NO_OVERRIED = 2;
