...
public class BeanFactoryTestV5 extends AbstractV5Test {
    ...
    public void testGetBeanByType() throws Exception {
        ...
        {
            AspectJBeforeAdvice advice = (AspectJBeforeAdvice) this.getAdice(AspectJBeforeAdvice.class, advices);
        ...
        {
            AspectJAfterReturningAdvice advice = (AspectJAfterReturningAdvice) this.getAdice(AspectJAfterReturningAdvice.class, advices);
        ...
        {
            AspectJAfterThrowingAdvice advice = (AspectJAfterThrowingAdvice) this.getAdice(AspectJAfterThrowingAdvice.class, advices);
    ...
    public Object getAdice(Class<?> type, List<Object> advices) {
